  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-8 h-[500px] shadow-sm flex flex-col transition-colors">
          <div className="mb-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('trendWealth')}</h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm">{t('trendWealthDesc')}</p>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-8 h-[500px] shadow-sm flex flex-col transition-colors">
          <div className="mb-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('evolutionRetirement')}</h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm">{t('evolutionRetirementDesc')}</p>
          </div>
          <div className="flex-1">
            <ResponsiveContainer width="100%" height="100%">
