      ...
      >
        ...
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-700/30 stagger-1">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 truncate max-w-[250px]">
              {itemName}
            </p>
          </div>
          <button
              ...
              {history.map((rev, idx) => {
                ...
                return (
                  <div key={rev.timestamp + idx} className="relative pl-6">
                    <span
                      className={`absolute -left-[9px] top-1 w-4 h-4 rounded-full ${bgColor} ring-4 ring-white dark:ring-slate-800`}
                    />
